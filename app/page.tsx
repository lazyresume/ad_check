...
export default function Home() {
  ...
  return <main>
    ...
    <section className="scene hero-scene" id="top"><div className="scene-inner hero-inner"><p className="tiny-label">LAZYRESUME / MONTHLY CAREER RECORD</p><h1>이력서 업데이트,<br /><strong>이제 매달<br />전화 한 통으로</strong><br />끝내세요!</h1><p className="scene-sub">이직은 하고 싶은데,<br />주말에 이력서 열기조차 귀찮으셨죠?<br /><br />내가 편한 시간에 잠깐,<br />친구와 통화하듯 이번 달에 한 일을 들려주세요.</p><a className="black-pill" href="#story">어떻게 하는지 보기 <span>↓</span></a></div><div className="hero-art"><div className="phone"><div className="phone-top">게으른 이력서 <span>●●●</span></div><div className="phone-wave"><i /><i /><i /><i /><i /></div><p>이번 달에<br /><b>가장 뿌듯했던 일은?</b></p><small>이번 달의 통화</small><div className="phone-button">●</div></div></div></section>
